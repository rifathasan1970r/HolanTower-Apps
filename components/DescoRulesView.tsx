    ...
    <div className="pb-24 animate-in slide-in-from-right duration-500 bg-slate-50 min-h-screen relative">
      ...
      <div className="bg-white sticky top-[60px] z-10 border-b border-slate-100 shadow-sm transition-all">
        ...
        <div className="flex items-center justify-center px-6 py-4">
          <div className="text-center animate-in zoom-in duration-300 flex items-center gap-3">
            ...
            <div>
                <h2 className="text-2xl font-bold text-slate-800">রিচার্জের নিয়ম</h2>
      ...
      <div className="p-5 space-y-4">
        <div className="bg-white p-10 rounded-3xl shadow-sm border border-slate-100 flex flex-col items-center justify-center text-center">
            ...
            <h3 className="text-2xl font-bold text-slate-800 mb-2">কাজ চলমান</h3>
            <p className="text-slate-500 font-medium">অপেক্ষা করুন...</p>
        </div>
      </div>
    </div>
  );
